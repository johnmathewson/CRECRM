...
**Build queue (remaining):** 5) contact form + consent columns + sms_optouts (marketing-site form STILL a stub), 6) Today absorbs Home; Properties absorbs Listings (Inbox retired 7/29; Comms log renamed Outreach tracker); Prospector launch-or-hide.
